...
public class DoctorAPIController {
    ...
    public DoctorAPIController(DrugService drugService, PrescriptionService prescriptionService,
    		DiagnosisService diagnosisService, ChatGPTDiagnosisService chatGPTDiagnosisService) {
